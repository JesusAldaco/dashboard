...
export default function DetalleMateriaPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const materia = useQuery(api.materias.obtenerMateriaPorId, { id: idMateria });
    const eliminarMateria = useMutation(api.materias.eliminarMateria);
            ...
            <Card className="max-w-2xl mx-auto">
                ...
                <CardContent className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="p-2 bg-muted rounded-md">{materia.nombreMateria}</div>
                    </div>
                </CardContent>
            </Card>
